...
Próximo passo: **File Upload**, **File Inclusion**, **Brute Force** — para fechar oficialmente a Fase 2. Pendente também: resolver o acesso ao DevTools do Firefox no Kali.
