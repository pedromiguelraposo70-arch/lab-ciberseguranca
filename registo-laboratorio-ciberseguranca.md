...
**Próximos passos (dentro desta sessão):** Decidir e, se fizer sentido, desenhar regras Wazuh próprias — ex.: um padrão de vários 4769 para SPNs diferentes vindos da mesma conta num curto espaço de tempo (indicador de Kerberoasting), e uma regra base que sequer reconheça o 4768 (pré-requisito para detetar AS-REP Roasting).
