...
**Nota de coerência (a decidir no VS Code):** a GPO chama-se `Hardening-Desligar-LLMNR-NBTNS`, mas na prática só o LLMNR ficou na GPO; o NBT-NS e o mDNS foram aplicados no cliente por falta de definição nativa no ADMX deste Server. Ou se renomeia a GPO para refletir só o LLMNR, ou se mantém o nome com esta nota — fica ao teu critério.
...
**Autoavaliação — Consigo explicar isto a alguém?** *(a preencher por ti)*
